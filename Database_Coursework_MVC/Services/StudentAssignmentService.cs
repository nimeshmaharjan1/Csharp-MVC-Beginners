        ...
        public IEnumerable<StudentAssignmentModel> GetAssignmentResultOfStudent(int studentId)
        {
            ...
            using (OracleConnection con = new OracleConnection(_connectionString))
            {
                using (OracleCommand cmd = new OracleCommand())
                {
                    ...
                    cmd.Connection = con;
                    cmd.BindByName = true;
                    cmd.CommandText = "select module.module_code, student_module_assignment.assignment_type, student_module_assignment.grade," +
                        " student_module_assignment.student_id, student_module_assignment.status" +
                        " from module, student_module_assignment" +
                        " where student_module_assignment.module_code = module.module_code and student_module_assignment.student_id = " + studentId + "";
